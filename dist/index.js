...
const template = templateArg !== null && templateArg !== void 0 ? templateArg : `${process.argv[1].replace(".bin", "").replace(/node_modules\/gen-env-dts\/.*?/g, "node_modules/gen-env-dts")}/template.d.ts`;
